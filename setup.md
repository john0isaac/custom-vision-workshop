...
1. Navigate to [https://github.com/john0isaac/custom-vision-workshop](https://github.com/john0isaac/custom-vision-workshop)
1. Select **Fork** to create a copy of the repository in your GitHub account
